if [ -d "tests/cypress/administration" ]; then
    cd shopware
    ...
    npm --prefix ../tests/cypress/administration run cy:run:chrome -- -c numTestsKeptInMemory=0,watchForFileChanges=false,video=true --headless
